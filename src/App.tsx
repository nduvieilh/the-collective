...
function App() {
  ...
  return (
    ...
    >
      ...
      {/* Main UI Container */}
      <div className="flex-1 flex flex-col backdrop-blur-sm bg-white bg-opacity-10 m-4 rounded-2xl shadow-2xl border border-white border-opacity-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-white bg-opacity-20 text-white hover:bg-opacity-30 transition-all duration-200 shadow-lg"
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          {showBotConfig && (
            <div className="w-80 border-l border-white border-opacity-20">
              <BotConfig />
            </div>
          )}
        </div>
